...
.main {
  ...
  position: relative;
  margin: 0 auto;
  background-image: url("<?=base_url();?>public/front/images/bg_3.jpg");
        ...
        <div class="MYcontainer">
            <div class="signup-content">
                <form method="POST" id="signup-form" class="signup-form" action="<?=base_url('/register');?>">
                    ...
                    <div class="form-group">
                        <input type="password" class="form-input" name="password" id="password" placeholder="Password" value="<?php echo set_value('password'); ?>" />
